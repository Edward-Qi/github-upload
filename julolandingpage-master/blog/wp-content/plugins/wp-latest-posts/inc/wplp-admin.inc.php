...
class WPLPAdmin
{
    ...
    private $switch_button = array(
        'show_title' , 'full_height' , 'crop_img'
    );
    ...
    public function __construct($opts)
    {
        ...
        if (is_admin()) {
            ...
            if (isset($_GET['page']) && $_GET['page'] === 'wplp-widget') { // phpcs:disable WordPress.Security.NonceVerification.NoNonceVerification -- view only
    ...
    public function setupWPLPMenu()
    {
        ...
        // phpcs:disable WordPress.Security.NonceVerification.NoNonceVerification -- view only
    ...
    public function changeCatMultisite()
    {
        ...
        if (strpos($type, 'post') !== false) {
            ...
            $output .= '<li><input id="cat_all" type="checkbox" name="wplp_source_category[]" value="_all" class="ju-checkbox" />';
            $output .= '<label for="cat_all" class="post_cb">All</li>';
            foreach ($cats as $k => $cat) {
                $output .= '<li><input id="ccb_' . $k . '" type="checkbox" name="wplp_source_category[]" class="ju-checkbox"';
            ...
            $output .= '<li><input id="page_all" type="checkbox" name="wplp_source_pages[]" value="_all" class="ju-checkbox" />' .
                       '<label for="page_all" class="page_cb">All Pages</li>';

            foreach ($cats as $k => $page) {
                $output .= '<li><input id="pcb_' . $k . '" type="checkbox" name="wplp_source_pages[]" class="ju-checkbox"';
            ...
            $output .= '<li><input id="tags_all" type="checkbox" name="wplp_source_tags[]" value="_all"  class="ju-checkbox" />' .
                       '<label for="tags_all" class="tag_cb">All tags</li>';

            foreach ($cats as $k => $tag) {
                $output .= '<li><input id="tcb_' . $k . '" type="checkbox" name="wplp_source_tags[]" class="ju-checkbox"';
            ...
            $output .= '<li><input id="cat_list_all" type="checkbox" name="wplp_source_category_list[]" value="_all" class="ju-checkbox" />';
            $output .= '<label for="cat_list_all" class="cat_list_cb">All</li>';
            foreach ($cats as $k => $cat) {
                $output .= '<li><input id="cl_' . $k . '" type="checkbox" name="wplp_source_category_list[]" class="ju-checkbox"';
    ...
    public function loadAdminScripts($hook)
    {
        ...
        if ($current_page->base === 'toplevel_page_wplp-widget') {
            ...
            if (isset($_GET['view']) && $_GET['view'] === 'block') { // phpcs:ignore WordPress.Security.NonceVerification.NoNonceVerification -- view only
                wp_enqueue_script(
                    'wplp-picker',
