    ...
    <div class="settings-wrapper">
        ...
        <div class="text-content settings-wrapper-field">
            ...
            <select name="wplp_text_content" class="browser-default wplp-font-style width-30" id="text_content">
                <option value="0" class="short-text">
                    <?php ((isset($settings['text_content']) && $settings['text_content'] === '0') ? 'selected' : '') ?>
                    <?php esc_html_e('Full content', 'wp-latest-posts') ?>
                </option>
                <option value="1" class="short-text">
                    <?php ((isset($settings['text_content']) && $settings['text_content'] === '1') ? 'selected' : '') ?>
        ...
        <div class="after-content-text settings-wrapper-field">
            <div class="no-post float half-width">
                <label class="settings-wrapper-title"><?php esc_html_e('No Post Content', 'wp-latest-posts') ?></label>
